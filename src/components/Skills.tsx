...
const SkillCard = ({ 
  ...
  return (
    <div className="bg-white dark:bg-navy-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-24 mx-auto">
